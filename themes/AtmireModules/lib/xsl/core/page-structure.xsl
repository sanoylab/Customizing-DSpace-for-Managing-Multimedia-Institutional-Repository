...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="buildHead">
        <head>
            ...
            <!--This allows you to specify any meta tag using the pageMeta.-->
            <xsl:for-each select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='meta']">
                <meta http-equiv="{@qualifier}" content="{.}"/>
            </xsl:for-each>
            ...
            <link rel="stylesheet" media="screen" type="text/css" href="{concat($theme-path, '/lib/css/reset.css')}"/>
            <link rel="stylesheet" media="screen" type="text/css" href="{concat($theme-path, '/lib/css/base.css')}"/>
            <link rel="stylesheet" media="screen" type="text/css" href="{concat($theme-path, '/lib/css/helper.css')}"/>
            <link rel="stylesheet" media="screen" type="text/css" href="{concat($theme-path, '/lib/css/jquery-ui-1.8.13.custom.css')}"/>
            <link rel="stylesheet" media="screen" type="text/css" href="{concat($theme-path, '/lib/css/jquery-ui-overrides.css')}"/>
            <link rel="stylesheet" media="screen" type="text/css" href="{concat($theme-path, '/lib/css/style.css')}"/>
            <link rel="stylesheet" media="screen" type="text/css" href="{concat($theme-path, '/lib/css/style-atmire.css')}"/>
            <link rel="stylesheet" media="screen" type="text/css" href="{concat($theme-path, '/lib/css/jquery.notify.css')}"/>
            <link rel="stylesheet" media="screen" type="text/css" href="{concat($theme-path, '/lib/css/authority-control.css')}"/>

            <link rel="stylesheet" media="handheld" type="text/css" href="{concat($theme-path, '/lib/css/handheld.css')}"/>
            <link rel="stylesheet" media="print" type="text/css" href="{concat($theme-path, '/lib/css/print.css')}"/>

            <link rel="stylesheet" media="all" type="text/css" href="{concat($theme-path, '/lib/css/media.css')}"/>
    ...
    <xsl:template name="buildHeader">
        <div id="ds-header-wrapper">
            <div id="ds-header" class="clearfix">
                <a id="ds-header-logo-link" href="http://www.atmire.com" title="@mire" target="_blank">
                    <span id="ds-header-logo">&#160;</span>
                </a>
                <span id="ds-header-logo-text">admin modules</span>
