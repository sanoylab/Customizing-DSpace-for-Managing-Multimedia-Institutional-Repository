    ...
    <xsl:template name="itemSummaryList-DIM">
        ...
        <xsl:choose>
            <xsl:when test="'file' = $emphasis">
                ...
                <xsl:choose>
                    <xsl:when test="$submode='recent-submission'">
    ...
    <xsl:template match="mets:fileSec" mode="artifact-preview">
        ...
        <div class="thumbnail artifact-preview">
            <a class="image-link" href="{$href}">
 		    ...
 		    <xsl:when test="//mets:file[@MIMETYPE = 'image/jpeg']">
                        
			<i class="glyphicon glyphicon-picture thumbnail-icon"/>

                    </xsl:when>
 		    <xsl:when test="//mets:file[@MIMETYPE = 'audio/mp3']">
                        
			<i class="glyphicon glyphicon-music thumbnail-icon"/>

                    </xsl:when>
 <xsl:when test="//mets:file[@MIMETYPE = 'application/vnd.rn-realmedia']">
                        
			<i class="glyphicon glyphicon-music thumbnail-icon"/>

                    </xsl:when>

		    <xsl:when test="//mets:file[@MIMETYPE = 'video/mp4']">
