...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
                                        ...
                                        <div class="horizontal-slider clearfix">
                                            <div>
                                                <xsl:attribute name="class">
                                                    <xsl:text>col-xs-12 col-sm-12 </xsl:text>
                                                    <xsl:choose>
                                                        <xsl:when test="count(dri:options/*)=0">col-md-12</xsl:when>
                                                        <xsl:otherwise>col-md-9</xsl:otherwise>
                                                    </xsl:choose>
    ...
    <xsl:template name="buildHeader">
        ...
        <header>
            <div id="header-top" class="dark">
                <!--<img src="{$theme-path}/images/DSpace-logo-line.svg"/>-->
               <!-- <i18n:text>xmlui.homepage.head</i18n:text>-->
		 <i18n:text>UNITED NATIONS</i18n:text>
                    ...
                    <div class="row">
                        <div class="col-xs-7 col-sm-5 col-md-6">
                            <a href="{$context-path}/">
                                ...
                                <img class="logo" src="{$context-path}/static/images/logo-{$locale}.png"/>
                            </a>
                        </div>
                        <div class="col-xs-5 col-sm-7 col-md-6">
                                ...
                                <div class="navbar-header">
                                    ...
                                    <div class="navbar-header pull-right visible-xs hidden-sm hidden-md hidden-lg">
                                        <ul class="nav nav-pills pull-left ">
                                            ...
                                            <!-- Other links -->
                                            <li class="dropdown">
                                                <button class="dropdown-toggle navbar-toggle navbar-link" id="info-dropdown-toggle-xs" href="#" role="button" data-toggle="dropdown">
                                                    <b class="visible-xs glyphicon glyphicon-info-sign" aria-hidden="true"/>
                                                </button>
                                              <!--  <ul class="dropdown-menu pull-right" role="menu"
                                                    aria-labelledby="info-dropdown-toggle-xs" data-no-collapse="true">
                                                    <li>
                                                        <a href=""><i18n:text>xmlui.dri2xhtml.header.knowledge</i18n:text></a>
                                                    </li>
                                                    <li>
                                                        <a href=""><i18n:text>xmlui.dri2xhtml.header.about</i18n:text></a>
                                                    </li>
                                                    <li>
                                                        <a href=""><i18n:text>xmlui.dri2xhtml.header.blog</i18n:text></a>
                                                    </li>
                                                    <li>
                                                        <a href=""><i18n:text>xmlui.dri2xhtml.header.help</i18n:text></a>
                                                    </li>
                                                </ul>-->
 						...
 						<ul class="dropdown-menu pull-right" role="menu"
                                                    aria-labelledby="info-dropdown-toggle-xs" data-no-collapse="true">
                                                    <li>
                                                        <a href="">Knowledge Service Section</a>
                                                    </li>
                                                    <li>
                                                        <a href="">About</a>
                                                    </li>
                            ...
                            <div id="languages" class="pull-right">
                                <a>
                                    <xsl:attribute name="href">
                                        ...
                                        <xsl:text>?locale-attribute=en</xsl:text>
                                    </xsl:attribute>

                                    <img class="img-responsive">
                                            <xsl:attribute name="src">
                                                <xsl:value-of select="concat($context-path,'/static/images/flag_en.png')"/>
                                            </xsl:attribute>
                                ...
                                <a>
                                    <xsl:attribute name="href">
                                        ...
                                        <xsl:text>/</xsl:text>
                                        <xsl:value-of select="$request-uri"/>
                                        <xsl:text>?locale-attribute=fr</xsl:text>
                                    </xsl:attribute>

                                    <img class="img-responsive">
                                        <xsl:attribute name="src">
                                            <xsl:value-of select="concat($context-path,'/static/images/flag_fr.png')"/>
                                        </xsl:attribute>
                                        <xsl:attribute name="alt">
    ...
    <xsl:template name="buildSearchBar">
        <div id="header-search" class="inverted">
            <div class="container">
                <div>
                    <xsl:attribute name="class">
                        <xsl:call-template name="searchbar-left-cols"/>
                        <xsl:text> form</xsl:text>
                    </xsl:attribute>
                    <form class="ds-search-form" method="post">
                        ...
                        <fieldset>
                            <div class="input-group">
                                <input class="form-control" type="text" placeholder="xmlui.general.search.placeholder" i18n:attr="placeholder">
                                    <xsl:attribute name="class">
                                        <xsl:text>form-control </xsl:text>
                                        <xsl:call-template name="searchbar-input-class"/>
                                    </xsl:attribute>
                                ...
                                <span class="input-group-btn">
                                    <xsl:attribute name="class">
                                        <xsl:text>input-group-btn </xsl:text>
                                        <xsl:call-template name="searchbar-btn-group-class"/>
                                    </xsl:attribute>
                                    <button class="ds-button-field btn btn-dark" title="xmlui.general.go" i18n:attr="title">
                ...
                <div>
                    <xsl:attribute name="class">
                        <xsl:call-template name="searchbar-right-cols"/>
                        <xsl:text> link</xsl:text>
                    </xsl:attribute>
                    <a href="{$context-path}/discover" class="hidden-xs">
                        <i18n:text>xmlui.dri2xhtml.structural.search-advanced</i18n:text>
                    </a>
                    <xsl:call-template name="searchbar-right-content"/>
                </div>
            </div>
        </div>
    </xsl:template>
    ...
    <xsl:template name="searchbar-left-cols">
        <xsl:text>col-xs-12 col-sm-8</xsl:text>
    </xsl:template>
                ...
                <div class="col-xs-4 col-sm-4 hidden-print">
                    <div class="pull-right">
                        ...
                        <p class="follow-us-icons">
                            <a href="https://twitter.com/eca_official">
                                <i class="fa fa-twitter-square"></i>
                            </a>
                            <a href="http://www.facebook.com/EconomicCommissionforAfrica">
                                <i class="fa fa-facebook-square"></i>
                            </a>
                            <a href="">
                                <i class="fa fa-pinterest-square"></i>
                            </a>
                            <a href="http://www.flickr.com/photos/96044621@N08/">
                                <i class="fa fa-flickr"></i>
                            </a>
                            <a href="http://www.youtube.com/unecaVideo/">
