...
(function($){
    ...
    function assignGlobalEventHandlers() {
        $('.show-advanced-filters').click(function () {
            var wrapper = $('#aspect_discovery_SimpleSearch_div_discovery-filters-wrapper, .search_bitstreams_div');
    ...
    function renderFileFilterSection() {
        if($('input[type="radio"][value="bits"]').prop('checked')){
            $('#filters-overview-wrapper').append("<label href='#' class='label label-primary files-filter-label'>with files &times;</label>");
            addFileFilterEventHandler();
        }
        if($('input[type="radio"][value="nobits"]').prop('checked')){
            $('#filters-overview-wrapper').append("<label href='#' class='label label-primary files-filter-label'>without files &times;</label>");
            addFileFilterEventHandler();
        }
    }

    function addFileFilterEventHandler() {
        $('.files-filter-label').click(function() {
